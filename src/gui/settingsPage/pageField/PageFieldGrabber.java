 ...
 */
public abstract class PageFieldGrabber<T extends Component> {

    public String getDataString(PageField<T> page, T t) {
        System.err.println("The getDataString() action is not implemented for " + page.getFieldName());
        return null;
    }

    public int getDataInt(PageField<T> page, T t) {
        System.err.println("The getDataInt() action is not implemented for " + page.getFieldName());
        return 0;
    }

    public boolean getBoolean(PageField<T> page, T t) {
